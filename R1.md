...
**Today's Progress**: Worked on freecodecamps CSS basics on how to style an element using the id # attribute.  Learned to djust padding and margins of an element using customizations and clockwise notations and how to override styles.
...
**Today's Progress**: Completed freecodecamp's Basic CSS tutorials.  Will spend additional time today reviewing to ensure I have retained the basics before moving on. 
